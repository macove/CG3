...
Matrix4x4 MyMath::MakeInverseTransposeMatrix(const Matrix4x4& matrix)
{
	Matrix4x4 inverseMatrix = Inverse(matrix);
	Matrix4x4 transposeMatrix = {
		inverseMatrix.m[0][0], inverseMatrix.m[1][0], inverseMatrix.m[2][0], inverseMatrix.m[3][0],
		inverseMatrix.m[0][1], inverseMatrix.m[1][1], inverseMatrix.m[2][1], inverseMatrix.m[3][1],
		inverseMatrix.m[0][2], inverseMatrix.m[1][2], inverseMatrix.m[2][2], inverseMatrix.m[3][2],
		inverseMatrix.m[0][3], inverseMatrix.m[1][3], inverseMatrix.m[2][3], inverseMatrix.m[3][3]
	};
